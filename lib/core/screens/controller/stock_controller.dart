...
class StockController extends ChangeNotifier {
  ...
  Future<bool> addItem() async {
    ...
    try {
      ...
      final String? imageUrlValue = imageUrl.text.trim().isEmpty 
          ? null 
          : imageUrl.text.trim();
      
      // Debug log
      debugPrint('Adding item with image URL: $imageUrlValue');
      ...
      // Debug log
      debugPrint('Item added successfully: ${response['id']}');
      debugPrint('Saved image URL: ${response['image']}');
