...
class EmployerScreen extends StatelessWidget {
              ...
              return RefreshIndicator(
                ...
                child: CustomScrollView(
                  slivers: [
                    ...
                    SliverToBoxAdapter(
                      child:  Consumer<EmployerController>(
                        builder: (context, controller, _) {
                          ...
                          return FloatingActionButton.extended(
                            ...
                            label: Text(
                              'Checkout (DT ${NumberFormat('#,##0').format(controller.totalAmount)})',
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Spacer(),
                  Text(
                    ' ${NumberFormat('#,##0').format(item.price)} DT',
  ...
  void _showCartSummary(BuildContext context) {
    ...
    // Build cart items list before opening the modal
                ...
                children: [
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ListTile(
                          ...
                          subtitle: Text(
                            ' ${NumberFormat('#,##0').format(item.price)} x $quantity DT',
                            style: AppTheme.bodySmall,
                          ),
                          trailing: Text(
                            ' ${NumberFormat('#,##0').format(subtotal)} DT',
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        'DT ${NumberFormat('#,##0').format(controller.totalAmount)} DT',
